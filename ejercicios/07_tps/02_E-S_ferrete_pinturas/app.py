...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        t_celsius = int(self.txt_temperatura_c.get())
        
        resultado = (t_celsius * 9 / 5) + 32

        alert("Fahrenheit a Celsius!", f"{resultado} ºF")

    def btn_convertir_f_c_on_click(self):
        t_fahrenheit = int(self.txt_temperatura_f.get())
        
        resultado = (t_fahrenheit - 32) * 5 / 9

        alert("Fahrenheit a Celsius!", f"{resultado} ºC")
